                  ...
                  <ul className='flex flex-col py-4 space-y-1'>
                    ...
                    >
                      <div className='flex flex-row items-end h-8'>
                        <IconsShop />
                        <div className='text-sm font-light text-gray-500 ml-2 text-nowrap'>
                    ...
                    <li>
                      ...
                      >
                        <li className='h-6 py-5 relative flex items-center focus:outline-none hover:bg-gray-50 border-l-4 border-transparent hover:border-indigo-500'>
                          <Link
                            to='/estimate-list'
                            className='pl-[56px] pr-[23px] text-sm'
                          >
