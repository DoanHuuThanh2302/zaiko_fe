                  ...
                  <ul className='flex flex-col py-4'>
                    ...
                    <li>
                      ...
                      >
                        ...
                        <li
                          className={`h-6 py-5 relative right-[10px] flex items-center focus:outline-none ${getNavLinkClass(
                            '/purchase-management/purchase-slip',
                            'bg-[#1e4e79] w-[257px]'
                          )}`}
                        >
                          <Link
                        ...
                        <li
                          className={`h-6 py-5 relative right-[10px] flex items-center focus:outline-none ${getNavLinkClass(
                            '/purchase-management/purchase-list',
                            'bg-[#1e4e79] w-[257px]'
                          )}`}
                        >
                          <Link
                        ...
                        <li
                          className={`h-6 py-5 relative right-[10px] flex items-center focus:outline-none ${getNavLinkClass(
                            '/purchase-management/purchase-payment-slip',
                            'bg-[#1e4e79] w-[257px]'
                          )}`}
                        >
                          <Link
                        ...
                        <li
                          className={`h-6 py-5 relative right-[10px] flex items-center focus:outline-none ${getNavLinkClass(
                            '/purchase-management/payment-deadline',
                            'bg-[#1e4e79] w-[257px]'
                          )}`}
                        >
                          <Link
                        ...
                        <li
                          className={`h-6 py-5 relative right-[10px] flex items-center focus:outline-none ${getNavLinkClass(
                            '/purchase-management/list-of-accounts-payable',
                            'bg-[#1e4e79] w-[257px]'
                          )}`}
                        >
                          <Link
